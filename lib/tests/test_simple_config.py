...
class Test_SimpleConfig(SequentialTestCase):
    ...
    def setUp(self):
        ...
        self.garlium_dir = tempfile.mkdtemp()
        # Do the same for the user dir to avoid overwriting the real configuration
        # for development machines with garlium installed :)
        self.user_dir = tempfile.mkdtemp()

        self.options = {"garlium_path": self.garlium_dir}
    ...
    def tearDown(self):
        ...
        shutil.rmtree(self.garlium_dir)
    ...
    def test_simple_config_user_config_is_used_if_others_arent_specified(self):
        ...
        fake_read_user = lambda _: {"garlium_path": self.garlium_dir}
        read_user_dir = lambda : self.user_dir
    ...
    def test_user_config_is_not_written_with_read_only_config(self):
        ...
        contents = None
        with open(os.path.join(self.garlium_dir, "config"), "r") as f:
            contents = f.read()
